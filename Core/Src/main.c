...
uint8_t rxTempBuf[255];
uint8_t	rxTempBufIndex = 0;

uint8_t rx6TempBuf[255];
uint8_t	rx6TempBufIndex = 0;

uint8_t txData = 0;
uint8_t txHexData[] = {0x61, 0x6c, 0x69};
//uint8_t txBuf[30] = "Hi Everyone\n\r";
